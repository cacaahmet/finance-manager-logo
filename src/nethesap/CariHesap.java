...
public class CariHesap extends JFrame {

    private JComboBox<String> kisiComboBox;
    // Cari hesap için kişi seçimi
    ...
    public CariHesap() {
        ...
        // === KİŞİ SEÇİMİ ===
        JLabel kisiLabel = new JLabel("Kişi Seçiniz:");
        kisiLabel.setForeground(Color.WHITE);
        kisiLabel.setFont(new Font("Segoe UI", Font.BOLD, 18));
        kisiLabel.setBounds(50, 50, 150, 30);
        backgroundLabel.add(kisiLabel);

        // Boş JComboBox (sonradan doldurulacak)
        kisiComboBox = new JComboBox<>();
        kisiComboBox.setBounds(200, 50, 250, 30);
        backgroundLabel.add(kisiComboBox);
        ...
        // Tarih görünümünü gg/MM/yyyy yapıyoruz
        ...
        // Buton tıklandığında çalışacak metot
        ...
        tableModel.setColumnIdentifiers(new Object[]{
                "Müşteri Adı", "Müşteri Kodu", "Telefon", "Adres",
                "Bakiye", "Tarih", "Açıklama", "Borç", "Alacak"
        });
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new CariHesap().setVisible(true));
    }
}