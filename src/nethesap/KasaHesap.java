...
public class KasaHesap extends JFrame {

    private JComboBox<String> kisiComboBox;   // Kişi seçimi için ComboBox
    ...
    public KasaHesap() {
        ...
        tableModel.setColumnIdentifiers(new Object[]{
                "Kasa Adı", "Bakiye", "Tarih", "İşlem Türü", "Tutar", "Açıklama"
        });
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new KasaHesap().setVisible(true));
    }
}